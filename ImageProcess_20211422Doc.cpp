...
// ImageProcess_20211422Doc.cpp: CImageProcess20211422Doc 클래스의 구현
//
...
// CImageProcess20211422Doc

IMPLEMENT_DYNCREATE(CImageProcess20211422Doc, CDocument)

BEGIN_MESSAGE_MAP(CImageProcess20211422Doc, CDocument)
END_MESSAGE_MAP()


// CImageProcess20211422Doc 생성/소멸

CImageProcess20211422Doc::CImageProcess20211422Doc() noexcept
{
...
CImageProcess20211422Doc::~CImageProcess20211422Doc()
{
	if (inputImg != NULL) {
...
BOOL CImageProcess20211422Doc::OnNewDocument()
{
...
// CImageProcess20211422Doc serialization

void CImageProcess20211422Doc::Serialize(CArchive& ar)
{
	if (ar.IsStoring())
	{
...
// 축소판 그림을 지원합니다.
void CImageProcess20211422Doc::OnDrawThumbnail(CDC& dc, LPRECT lprcBounds)
{
...
// 검색 처리기를 지원합니다.
void CImageProcess20211422Doc::InitializeSearchContent()
{
...
void CImageProcess20211422Doc::SetSearchContent(const CString& value)
{
	if (value.IsEmpty())
	{
...
// CImageProcess20211422Doc 진단

#ifdef _DEBUG
void CImageProcess20211422Doc::AssertValid() const
{
	CDocument::AssertValid();
}

void CImageProcess20211422Doc::Dump(CDumpContext& dc) const
{
	CDocument::Dump(dc);
}
#endif //_DEBUG
...
// CImageProcess20211422Doc 명령


void CImageProcess20211422Doc::PixelAdd()
{
...
void CImageProcess20211422Doc::PixelSub()
{
	if (inputImg == NULL) { return; }
...
void CImageProcess20211422Doc::PixelDiv()
{
	if (inputImg == NULL) { return; }
...
void CImageProcess20211422Doc::PixelMul()
{
	if (inputImg == NULL) { return; }
...
void CImageProcess20211422Doc::PixelHistoEq()
{
	if (inputImg == NULL) { return; }
	if (depth != 1) { return; }

	CImageProcess20211422Doc* pDoc = this;
...
void CImageProcess20211422Doc::PixelLsContrast()
{
	if (inputImg == NULL) { return; }
...
void CImageProcess20211422Doc::PixelBinarization()
{
...
void CImageProcess20211422Doc::LoadTwoImages()
{
	CFile file;
...
void CImageProcess20211422Doc::LoadImageFile(CArchive& ar)
{
	// TODO: 여기에 구현 코드 추가.
	int maxValue;
...
void CImageProcess20211422Doc::LoadSecondImageFile(CArchive& ar)
{
	// TODO: 여기에 구현 코드 추가.
	int maxValue;
	char type[16], buf[256];
